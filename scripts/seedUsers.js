...
var connectDB_1 = require("../src/lib/connectDB");
function seedUsers() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, connectDB_1.default];
                case 1:
                    client = _b.sent();
                    db = client.db("next-event");
                    saltRounds = 10;
                    ...
                    if (!ADMIN_USERNAME || !ADMIN_EMAIL || !ADMIN_PASSWORD || !USER_USERNAME || !USER_EMAIL || !USER_PASSWORD) {
